        ...
        userCheckPromise = user_check
          ...
          .then((response) => {
            ...
            if (
              ...
              data.data.is_digital_Id_verified !== "suspended"
            ) {
              return true;
            } else {
              if (
...
export const GetAllPaymentStatus = async () => {
  const response = await public_instance
    .get("/payment/payment-status-list/")
    .then((res) => {
      return res?.data;
    })
    .catch((error) => {
...
export const GetBudpayBanks = async () => {
  const response = await public_instance
    .get("/payment/budpay-bank-list/NGN")
    .then((res) => {
      return res?.data;
    })
    .catch((error) => {
...
export const GetFlutterBanks = async () => {
  const response = await public_instance
    .get("/payment/flutterwave-bank-list/NG", {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const changePassword = async (data) => {
  const response = await private_instance
...
export const resetEmail = async (data) => {
  const response = await public_instance
    .post("/send-password-reset-email/", data)
    .then((res) => {
      return res;
    })
    .catch((error) => {
...
export const transactionHistory = async (data) => {
  const response = await private_instance
    .post("/payment/transaction-history/", data, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const completedPayment = async (data) => {
  const response = await private_instance
    .post("/payment/completed-transactions/", data, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const createRecipient = async (data) => {
  const response = await private_instance
    .post("/payment/recipient-create/", data, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const getUserRecipient = async (id) => {
  const response = await private_instance
    .get(`/payment/recipient-update/${id}`, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const updateUserRecipient = async (id, data) => {
  const response = await private_instance
    .post(`/payment/recipient-update/${id}`, data, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const deleteRecipient = async (id) => {
  const response = await private_instance
    .delete(`/payment/recipient-update/${id}`, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const recipientList = async (data) => {
  const response = await private_instance
    .post("/payment/recipient-list/", data, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const activEmail = async (data) => {
  const response = await public_instance
    .post(`/activate-email/`, { customer_id: data })
    .then((res) => {
      return res?.data;
    })
    .catch((error) => {
...
export const userCharge = async (data) => {
  const response = await private_instance
    .post(`/payment/stripe/user-charge/`, data, {
      headers: {
        //'Content-Type': 'application/json',
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const ZaiDashPayTo = async (data) => {
  const response = await private_instance
    .post(`/payment/zai-payto-login/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const ZaiDashPayId = async (data) => {
  const response = await private_instance
    .post(`/payment/zai-payid-login/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const verifyPayId = async (data) => {
  const response = await private_instance
    .post(`/payment/zai-payid-check/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const verifyPayTo = async (data) => {
  const response = await private_instance
    .post(`/payment/zai-payto-check/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const createPayId = async (data) => {
  const response = await private_instance
    .post(`payment/zai-payid-register/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const createAgreement = async (data) => {
  const response = await private_instance
    .post(`payment/zai-create-agreement/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const updateAgreement = async (data) => {
  const response = await private_instance
    .post(`payment/zai-update-agreement/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const createTransaction = async (data) => {
  const response = await private_instance
    .post(`payment/create-transaction/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const pendingTransactions = async () => {
  const response = await private_instance
    .get(`payment/pending-transactions/`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const setPreferredCurrency = async (data) => {
  const response = await private_instance
    .post(`destination-currency/`, data, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const checkExistence = async () => {
  let response = await private_instance
    .get("/user-exist/", {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
...
export const getCouponList = async (currency) => {
  const response = await private_instance
    .get(`/payment/referrals-list/${currency}/`, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const applyReferralCode = async (data) => {
  const response = await private_instance
    .post("/payment/apply-referral-code/", data, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const hitNewsletter = async (data) => {
  const response = await public_instance
    .post("/payment/subscribe-newsletter/", data)
    .then((res) => {
      return res?.data;
    })
    .catch((err) => {
...
export const checkExistingAccount = async (data) => {
  const response = await private_instance
    .post("/payment/account-number-validation/", data, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const validatePayId = async (data) => {
  const response = await private_instance
    .post("/payment/validate-payid/", data, {
      headers: {
        Authorization: `Bearer ${sessionStorage.getItem("token")}`,
      },
    })
...
export const fetchAccountUsage = async () => {
  const response = await private_instance
    .post(
      "/payment/transaction-usage-details/",
      {},
      {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
